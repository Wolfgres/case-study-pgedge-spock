/*
Copyright © 2022 Wolfgres info@wolfgres.com
...
func start() {
	...
	logrus.Info("************************************************")
	logrus.Info("")
	logrus.Info("Start de Stress test Name Stress Test: ", nameStressTest)

	logrus.Debug("Database name set: ", nameStressTest)

	services.GenerateStressTest()
}
